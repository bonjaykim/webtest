...
export default function TeamCardStyle2({ part }: TeamCardProps) {
  ...
  return (
    ...
    >
      <div
        className="rounded-lg p-5 h-full transition-all duration-300 shadow-md"
        style={{
      ...
      >
        ...
        >
          {Icon && <Icon size={24} style={{ color: isHovered ? "white" : "hsl(var(--muted-foreground))" }} />}
        </div>
        <h3
